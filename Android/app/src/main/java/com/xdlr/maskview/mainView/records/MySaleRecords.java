package com.xdlr.maskview.mainView.records;
...
import com.xdlr.maskview.mainView.records.adapter.MySaleRecordsAdapter;
import com.xdlr.maskview.mainView.records.beans.SaleRecordsBean;
...
public class MySaleRecords extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showRecyclerView() {
        ...
        //创建适配器
        adapter = new MySaleRecordsAdapter(myContext, saleRecordsBean.getData());
        //RecyclerView绑定适配器
