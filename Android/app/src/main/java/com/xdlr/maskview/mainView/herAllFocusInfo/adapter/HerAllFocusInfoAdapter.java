package com.xdlr.maskview.mainView.herAllFocusInfo.adapter;
...
import com.xdlr.maskview.mainView.herAllFocusInfo.bean.HerAllFocusInfoBean;
import com.xdlr.maskview.mainView.login.LoginByPhoneCode;
import com.xdlr.maskview.mainView.mine.MineActivity;
...
public class HerAllFocusInfoAdapter extends RecyclerView.Adapter<HerAllFocusInfoAdapter.BaseViewHolder> {
    ...
    public HerAllFocusInfoAdapter(Context context, List<HerAllFocusInfoBean.DataBean> beanList, boolean isMine) {
    ...
    public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(mContext, R.layout.item_her_all_focus_info, null);
    ...
    public class BaseViewHolder extends RecyclerView.ViewHolder {
        ...
        public BaseViewHolder(@NonNull View itemView) {
            super(itemView);
            mItemIvHeadView = itemView.findViewById(R.id.item_iv_herAllFocusInfo_headView);
            mItemTvUserName = itemView.findViewById(R.id.item_tv_herAllFocusInfo_userName);
            mItemTvFocus = itemView.findViewById(R.id.item_tv_herAllFocusInfo_focus);
            mItemTvCancelFocus = itemView.findViewById(R.id.item_tv_herAllFocusInfo_cancelFocus);
            mItemLvJumpHerInfo = itemView.findViewById(R.id.lv_item_jumpHerInfo_focus);
        }

        @SuppressLint("SetTextI18n")
        public void setData(HerAllFocusInfoBean.DataBean bean) {
