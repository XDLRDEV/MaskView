 ...
 */
public class Watermarkextractzero {
    private double[] binaryFeature;

    public Watermarkextractzero(double[] a){
     ...
     */
    public static Watermarkextractzero watermarkextractzero(double[][] matrix){
        int bpf_cbb=8;
        int bpf_cbs=4;
        int chf_len=36;
        int bpf_num=64;
        ...
        return new Watermarkextractzero(feature);
    }
}
